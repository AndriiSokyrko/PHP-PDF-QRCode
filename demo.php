...
//	$rowLabels                       = array( "SupaWidget", "WonderWidget", "MegaWidget", "HyperWidget" );
	$rowLabels                       = array( $_SESSION['pr1'], $_SESSION['pr2'], $_SESSION['pr3'], $_SESSION['pr4'] );
	$chartXPos                       = 25;
	$chartYPos                       = 80;
	$chartWidth                      = 60;
	$chartHeight                     = 80;
...
//	);
	...
	$data = array(
		array( $_SESSION['pr1q1'], $_POST['pr1q2'], $_SESSION['pr1q3'], $_SESSION['pr1q4'] ),
		array( $_SESSION['pr2q1'], $_POST['pr2q2'], $_SESSION['pr2q3'], $_SESSION['pr2q4'] ),
		array( $_SESSION['pr3q1'], $_POST['pr3q2'], $_SESSION['pr3q3'], $_SESSION['pr3q4'] ),
		array( $_SESSION['pr4q1'], $_POST['pr4q2'], $_SESSION['pr4q3'], $_SESSION['pr4q4'] ),
	);
	...
	foreach ( $data as $dataRow ) {
		if ( isset( $rowLabels[ $row ] ) ) {
			...
			for ( $i = 0; $i < count( $columnLabels ); $i ++ ) {
				$pdf->Cell( 14, 8, ( '$' . $dataRow[ $i ] ), 1, 0, 'C', $fill );
			}
		}
		$row++;
		$fill = !$fill;
...
if ($maxTotal==0) header( "location: index.php" );
